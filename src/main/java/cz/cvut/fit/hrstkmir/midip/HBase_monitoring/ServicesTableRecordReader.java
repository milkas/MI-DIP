 ...
 * @author mira
 */
public class ServicesTableRecordReader extends TableRecordReader {
    ...
    int numberOfRow= 0;
    public ServicesTableRecordReader() throws IOException {
    ...
    public boolean nextKeyValue() throws IOException, InterruptedException {
        ...
        if (value != null && value.size() > 0) {
            ...
            for (int i = 0; i < numberOfServices; i++) {
                if (value.getValue(Bytes.toBytes("sluzba"), Bytes.toBytes("rok" + (2000 + i))) != null) {
                    key.set(value.getValue(Bytes.toBytes("sluzba"), Bytes.toBytes("rok" + (2000 + i))));
                    rc++;
